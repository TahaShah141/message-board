...
export default function Home() {
    ...
    <div className="flex gap-4 m-3">
        ...
        <button className="bg-neutral-700 text-white p-2 rounded-md shadow-black shadow-sm" onClick={() => dispatch({type: 'SET_MESSAGES', payload: [{dummyData: "dummy", _id: 123, message: "test123"}, {dummyData: "dummy", _id: 456, message: "test456"}, {dummyData: "dummy", _id: 789, message: "test789"}]})}>Set Message</button>
